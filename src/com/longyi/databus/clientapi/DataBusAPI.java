...
public class DataBusAPI {
	private static final String InProEndpoint=DATABUS.LOCAL_JAVA_DAEMON_ENDPOINT;
	...
	public static void main(String[] args)
	{
		...
		String data="hahha";
		//byte[] datat=new byte[257*1024];
		_dataApi.sendMessage("love", data.getBytes());
		...
		_dataApi.insertAFile("Client.cpp", "/home/sophia-long/GCCTEST/Client.cpp");
